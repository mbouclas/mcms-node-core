module.exports = (function(App){
    ...
    command.prototype.fire = function(callback){
        ...
        var that = this,
            ...
            destLangFolder = App.Config.baseDir + '/App/Lang/packages/' + this.module,
        ...
        //publish Lang
        if (fs.existsSync(langFolder)) {//Check for config files
            asyncArr.push(checkFolder.bind(null,destLangFolder));
            asyncArr.push(publishLang.bind(null,langFolder,destLangFolder));
        }
    ...
    function publishLang(srcFolder,destFolder,callback){
