module.exports = (function(App,DB,Connection){
    ...
    return {
        ...
        activateUser : require('./' + DB + '/activateUser')(App,Connection),
        forgotPassword : require('./' + DB + '/forgotPassword')(App,Connection),
        resetUserPassword : require('./' + DB + '/resetUserPassword')(App,Connection)
    };
});