        ...
        function(req,username, password, done) {
            ...
            handler.findByCredentials(lookUp,function(err,user){
                ...
                if (req.body[App.Config.auth.credentials.rememberMeField]) {
                    req.session.cookie.maxAge = App.Config.auth.rememberMeTTL;//whatever the default is
                 } else {
                    req.session.cookie.maxAge = App.Config.app.sessionTTL * 60;//whatever the default is
                 }
