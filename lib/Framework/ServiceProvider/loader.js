    ...
    for (var a in sp){
        ...
        asyncObj[sp[a]] = function(sp,callback){
            ...
            if (fs.existsSync(baseAppPath + '/routes.js')) {
                ...
                App.serviceProviders[provider.packageName].App.locals.Route = Route;

                if (fs.existsSync(packagePath + '/Controllers')){
                    App.serviceProviders[provider.packageName].controllers = App.loadServices(packagePath + '/Controllers',true,provider);//load possible controllers
                ...
                App.serviceProviders[provider.packageName].Route = Route;
